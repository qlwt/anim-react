...
export type InitDef_New_Sequence_Src_Generic = readonly InitDef["initapi"][]

export type InitDef_New_Sequence_Src_InferPoint<Src extends InitDef_New_Sequence_Src_Generic> = {
    [K in keyof Src]: InputDef_InferOutput<Src[K]>
}

export type InitDef_New_Sequence_Src_Point<Src extends InitDef_New_Sequence_Src_Generic> = ac.AnimSequence_Point<
    InitDef_New_Sequence_Src_InferPoint<Src>
>

type Src_Generic = InitDef_New_Sequence_Src_Generic
type Src_PointSequence<Src extends Src_Generic> = InitDef_New_Sequence_Src_Point<Src>
type Src_InferPoint<Src extends Src_Generic> = InitDef_New_Sequence_Src_InferPoint<Src>

export const initdef_new_sequence = function <Src extends Src_Generic>(src: Src): InitDef<Src_PointSequence<Src>> {
    return {
            ...
            src_os => ({
                ...
                next: (ipoint, lpoint) => {
                    ...
                    return {
                        ...
                        ipoint: { mergeptr: ipoint.mergeptr, children: r_ipoint as Src_InferPoint<Src> },
                        lpoint: { mergeptr: lpoint.mergeptr, children: r_lpoint as Src_InferPoint<Src> }
                    }
                }
            })
        )
